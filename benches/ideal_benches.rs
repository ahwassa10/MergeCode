...
use merge::ideal::{gen_ideal_n, hash_join_ideal, rust_sort, sort_ideal, sort_merge_join_ideal};
...
fn bench_sort_ideal(c: &mut Criterion) {
    let sizes = [1_000, 10_000, 100_000usize, 1_000_000];
...
criterion_group!(benches, bench_gen_ideal, bench_sort_ideal, bench_rust_sort, bench_sort_merge_join_ideal, bench_hash_join_ideal);
